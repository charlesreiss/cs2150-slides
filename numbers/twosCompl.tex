...
\draw[thick] (0, 0) -- (9, 0);
\draw[thick] (0,2mm) -- (0,-2mm) node[below,myl] {0000\ldots0000 \\ = $+0$};
\draw[thick] (9,2mm) -- (9,-2mm) node[below,myl] {1111\ldots1111 \\ = \myemph<1>{$-1$}};
\draw[thick] (4.45,2mm) -- (4.45,-2mm);
\draw[thick] (4.5,2mm) -- (4.5,-2mm);
\draw[thick,dotted] (4.45,-2mm) -- ++(-1cm,-0.2cm) node[below,myl] {0111\ldots1111 \\ = $2^{n-1}-1$};
\draw[thick,dotted] (4.5,2mm) -- ++(0cm,0.2cm) node[above,myl] {1000\ldots0000 \\ = \myemph<1>{$-2^{n-1}$}};
\begin{visibleenv}<2-3>
\draw[thick, dotted, green!50!black] (.5,0mm) -- ++(0cm,15mm) node[above] {0000\ldots0101 = $6$};
\draw[thick, dotted, green!50!black] (8.5,0mm) -- ++(0cm,15mm) node[above] {1111\ldots1010 = $-6$};
\end{visibleenv}
...
\begin{frame}{other 2's complement arithmetic}
    \begin{itemize}
        \item subtraction also the same as unsigned
        \item multiplication --- repeated addition --- mostly the same
            \begin{itemize}
                \item (but need some extra precision)
            \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{sign extension}
    \begin{itemize}
        ...
        \item<2> general rule: extend by copying the \textit{sign bit}:
            \begin{itemize}
                \item {\tt \myemph{1}101 0111} $\rightarrow$ {\tt 1111 1111 1101 0111}
                \item {\tt \myemph{0}010 1111} $\rightarrow$ {\tt 0000 0000 0010 1111}
            \end{itemize}
