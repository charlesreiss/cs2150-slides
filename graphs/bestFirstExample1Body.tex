...
\graph[spring layout]{
    A[graph at A] ->[edges from A,"2"] C,
A[graph at A] ->[edges from A,"1"] D,

B[graph at B] ->[edges from B,"2"] A,

C[graph at C] ->[edges from C,"1"] D,
C[graph at C] ->[edges from C,"2"] F,

D[graph at D] ->[edges from D,"5"] B,
D[graph at D] ->[edges from D,"1"] E,
D[graph at D] ->[edges from D,"6"] F,
D[graph at D] ->[edges from D,"5"] G,

E[graph at E] ->[edges from E,"1"] B,

F[graph at F] ->[edges from F,"10"] G,

G[graph at G] ->[edges from G,"3"] E,
