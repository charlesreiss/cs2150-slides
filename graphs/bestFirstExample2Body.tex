...
\graph[spring layout]{
    A[graph at A] ->[edges from A,"7"] B,
A[graph at A] ->[edges from A,"9"] C,
A[graph at A] ->[edges from A,"14"] G,

B[graph at B] ->[edges from B,"10"] C,
B[graph at B] ->[edges from B,"15"] D,
B[graph at B] ->[edges from B,"7"] A,

C[graph at C] ->[edges from C,"11"] D,
C[graph at C] ->[edges from C,"2"] G,
C[graph at C] ->[edges from C,"10"] B,
C[graph at C] ->[edges from C,"9"] A,

D[graph at D] ->[edges from D,"6"] E,
D[graph at D] ->[edges from D,"11"] C,
D[graph at D] ->[edges from D,"15"] B,

E[graph at E] ->[edges from E,"9"] G,
E[graph at E] ->[edges from E,"6"] D,

G[graph at G] ->[edges from G,"2"] C,
G[graph at G] ->[edges from G,"9"] E,
G[graph at G] ->[edges from G,"14"] A,
