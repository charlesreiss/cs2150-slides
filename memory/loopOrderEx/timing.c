...
#define MAX_RUNS 10 /* maximum number of runs before giving up */
#define MIN_TEST_CYCLES (200L * 1000L * 1000L) /* minimum number of cycles before giving up */
        /* tolerance of top K runs, e.g. 1005, 1000 means .5% */
#define TOLERANCE_NUMERATOR 1001
