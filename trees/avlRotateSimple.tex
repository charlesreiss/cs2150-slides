...
\begin{frame}{general single rotation}
\def\m{-}
...
\end{scope}
    \draw[->,line width=1mm,black!50] (-1, -1) -- (1, -1) node[midway,above,align=center] {rotate \\ right};
    \draw[<-,line width=1mm,black!50] (-1, -3) -- (1, -3) node[midway,above,align=center] {rotate \\ left};
\node at (0, -5) {
    $X < b < Y < a < Z$
};
\end{tikzpicture}
